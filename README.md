...
![CI](https://github.com/evnex/netlify-deploy/workflows/CI/badge.svg)
[![Dependencies](https://david-dm.org/evnex/netlify-deploy/status.svg)](https://david-dm.org/evnex/netlify-deploy)
[![Dev Dependencies](https://david-dm.org/evnex/netlify-deploy/dev-status.svg)](https://david-dm.org/evnex/netlify-deploy?type=dev)
...
* [Deploying drafts on each commit and publishing on push to master](https://github.com/evnex/netlify-deploy#deploying-drafts-on-each-commit-and-publishing-on-push-to-master)
* [Deploying drafts of pull requests and publishing on push to master](https://github.com/evnex/netlify-deploy#deploying-drafts-of-pull-requests-and-publishing-on-push-to-master)
* [Deploying drafts of pull requests and publish on release created](https://github.com/evnex/netlify-deploy#deploying-drafts-of-pull-requests-and-publish-on-release-created)
...
If you find any, please report them [here](https://github.com/evnex/action-report-coverage/issues) so they can be squashed.
